import { ChainId, Currency, currencyEquals, JSBI, Price, WDEV } from 'cypheriumswap'
...
export default function useUSDCPrice(currency?: Currency): Price | undefined {
  ...
  const tokenPairs: [Currency | undefined, Currency | undefined][] = useMemo(
    () => [
      ...
      [wrapped?.equals(USDC) ? undefined : wrapped, chainId === ChainId.CYPHER_MAINNET ? USDC : undefined],
      [chainId ? WDEV[chainId] : undefined, chainId === ChainId.CYPHER_MAINNET ? USDC : undefined]
    ],
